...
f.write("Echo Request Bytes Received (bytes)/tEcho Request Data Received (bytes)")
f.write(str(node1_data[6]) + "\t" + str(node1_data[7]) + "\n")
f.write("\nAverage RTT (miliseconds) " + str(node1_data[8]))
f.write("Echo Request Throughput (kB/sec) " + str(node1_data[9]))#input num here
f.write("Echo Request Goodput (kB/sec) " + str(node1_data[10]))#input num here
f.write("Average Reply Delay (microseconds) " + str(node1_data[11]))#input num here
f.write("Average Echo Request Hop Count " + str(node1_data[12]))#input num here
f.write("\n")
...
f.write("Echo Request Throughput (kB/sec) " + str(node2_data[9]))#input num here
f.write("Echo Request Goodput (kB/sec) " + str(node2_data[10]))#input num here
f.write("Average Reply Delay (microseconds) " + str(node2_data[11]))#input num here
f.write("Average Echo Request Hop Count " + str(node2_data[12]))#input num here
f.write("\n")
...
f.write("Echo Request Throughput (kB/sec) " + str(node3_data[9]))#input num here
f.write("Echo Request Goodput (kB/sec) " + str(node3_data[10]))#input num here
f.write("Average Reply Delay (microseconds) " + str(node3_data[11]))#input num here
f.write("Average Echo Request Hop Count " + str(node3_data[12]))#input num here
f.write("\n")
...
f.write("Echo Request Throughput (kB/sec) " + str(node4_data[9]))#input num here
f.write("Echo Request Goodput (kB/sec) " + str(node4_data[10]))#input num here
f.write("Average Reply Delay (microseconds) " + str(node4_data[11]))#input num here
f.write("Average Echo Request Hop Count " + str(node4_data[12]))#input num here
f.write("\n")
